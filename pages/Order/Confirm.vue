	...
	<view>
			...
			<view class="row" v-for="(item, index) in goodsList" :key="index">
				<view class="goods-info">
					...
					<view class="info">
						...
						<view class="spec">
							<text>选择:{{ item.spec }}</text>
							<text>数量:{{ item.number }}</text>
						</view>
						<view class="price-number">
							<view class="price">￥{{ (item.price * item.number) | toFixeds }}</view>
						</view>
					</view>
				</view>
			</view>
		...
		<view class="detail">
			<view class="row">
				...
				<view class="content">￥{{ goodsPrice | toFixeds }}</view>
			</view>
			<view class="row">
				<view class="amount">运费</view>
				<view class="content">￥{{ freight | toFixeds }}</view>
			</view>
		</view>
		<!-- 占位 -->
		...
		<view class="footer">
			<view class="settlement">
				<view class="sum">
					<text>合计:</text>
					<view class="money">￥{{ sumPrice | toFixeds }}</view>
				</view>
		...
		uni.getStorage({
			...
			success: res => {
				...
				for (let item of this.goodsList) {
					this.goodsPrice += item.number * item.price;
				}
				// 用户支付金额
